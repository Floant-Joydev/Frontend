...
// Separating out in sections
  ...
  let plantersProduct;
  if(allProduct){
    plantersProduct = [...allProduct].filter((obj) => obj.Category==='Planters' );
  }
  ...
  return (
    ...
    <section className="new-arrivals p1">
      ...
      >
        {newArrival && newArrival.slice(0,6).map((ele) => {
          return(
            <>
    ...
    <section className="new-arrivals p1">
      ...
      <div className="banner">
        ...
        <div className="inner-content">
          ...
          <p>we are first online marketplace for traditional flowers. we are first online marketplace for traditional flower we are first online marketplace for traditional flowers. we are first online marketplace for traditional flower we are first online marketplace for traditional flowers. we are first online marketplace for traditional flower</p>
          <h4>Main Features</h4>
          <p>we are first online marketplace for traditional flowers. we are first online marketplace for traditional flower we are first online marketplace for traditional flowers. we are first online marketplace for traditional flower we are first online marketplace for traditional flowers. we are first online marketplace for traditional flower</p>
          <div className="btn">
        ...
        <img className="puja-ful" src="../src/assets/image/flowers1.svg" alt="" />
      </div>
    ...
    <section className="new-arrivals p1">
      ...
      <Swiper
        ...
        // onSwiper={(swiper) => console.log(swiper)}
      >
        {seedProduct && seedProduct.slice(0,6).map((ele) => {
          return(
            <>
            <SwiperSlide key={ele._id}>< ProductCard id={ele._id} salePrice={ele.SalePrice} discount={ele.PriceDiscountPercentage} rating={ele.Rating} price={ele.Price} image={ele.ProductImage1} name={ele.ProductName} category={ele.Category} clr="var(--main-green)" /></SwiperSlide>
            </>
    ...
    <section className="new-arrivals p1">
      ...
      <Swiper
        ...
        // onSwiper={(swiper) => console.log(swiper)}
      >
        {plantersProduct && plantersProduct.slice(0,6).map((ele) => {
          return(
            <>
            <SwiperSlide key={ele._id}>< ProductCard id={ele._id} salePrice={ele.SalePrice} discount={ele.PriceDiscountPercentage} category={ele.Category} rating={ele.Rating} price={ele.Price} image={ele.ProductImage1} name={ele.ProductName} clr="var(--main-green)" /></SwiperSlide>
            </>
          )
        })}
      </Swiper>
    ...
    <section className="new-arrivals p1">
      ...
      <Swiper
        ...
        // onSwiper={(swiper) => console.log(swiper)}
      >
        {plantProduct && plantProduct.slice(0,6).map((ele) => {
          return(
            <>
            <SwiperSlide key={ele._id}>< ProductCard id={ele._id} salePrice={ele.SalePrice} discount={ele.PriceDiscountPercentage} category={ele.Category} rating={ele.Rating} price={ele.Price} image={ele.ProductImage1} name={ele.ProductName} clr="var(--main-green)" /></SwiperSlide>
            </>
    ...
    <section className="new-arrivals p1">
      ...
      <Swiper
        ...
        // onSwiper={(swiper) => console.log(swiper)}
      >
        <SwiperSlide><BlogCard image={blog1} des='The Hidden Power of “Maghai Paan” more than just chew' /></SwiperSlide>
        <SwiperSlide><BlogCard image={blog1} des='The Hidden Power of “Maghai Paan” more than just chew' /></SwiperSlide>
        <SwiperSlide><BlogCard image={blog1} des='The Hidden Power of “Maghai Paan” more than just chew' /></SwiperSlide>
        <SwiperSlide><BlogCard image={blog1} des='The Hidden Power of “Maghai Paan” more than just chew' /></SwiperSlide>
        <SwiperSlide><BlogCard image={blog1} des='The Hidden Power of “Maghai Paan” more than just chew' /></SwiperSlide>
    ...
    <section className="customer p1">
      ...
      <Swiper
        ...
        // onSwiper={(swiper) => console.log(swiper)}
      >
        <SwiperSlide ><CustomerCard clr="var(--customer-ash)" /></SwiperSlide>
        <SwiperSlide ><CustomerCard clr="var(--customer-blue)" /></SwiperSlide>
        <SwiperSlide ><CustomerCard clr="var(--customer-brown)" /></SwiperSlide>
        <SwiperSlide ><CustomerCard clr="var(--customer-green)" /></SwiperSlide>
        <SwiperSlide ><CustomerCard clr="var(--customer-ash)" /></SwiperSlide>
        <SwiperSlide ><CustomerCard clr="var(--customer-blue)" /></SwiperSlide>
        <SwiperSlide ><CustomerCard clr="var(--customer-brown)" /></SwiperSlide>
        <SwiperSlide ><CustomerCard clr="var(--customer-green)" /></SwiperSlide>
